...
int main() {
    ...
    BMI = pi*height*(radius * radius);

    cout << "\tThe total Volume of Cylinder is : " <<BMI;

    res = 2* pi * radius * (radius + height);

    cout << "\tThe total Surface Area of Cylinder is : " << res;
